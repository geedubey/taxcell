class UsersController < ApplicationController
  ...
  #before_filter :login_required, :except=>[:new,:activate,:forgot_password, :reset_password]
  ...
  def reset_password
    ...
    if (params[:user][:password] == params[:user][:password_confirmation]) 
      ...
      flash[:alert] = "Password and Confirmation password do not match." 
    end  
  end
  ...
  # can be accessed only by a user with role as "owner"
  def index
    @users = User.all
